...
const ProductCardHorizontal = () => {
  return (
    <div className="flex gap-2 h-[18vh] md:h-[11vh] xl:h-[15vh] border border-lightGray/30 rounded-lg overflow-hidden cursor-pointer hover:shadow-lg hover:shadow-lightGray-500/50">
      {/* top  */}
